...
Google の生成メディア API（Gemini Image, Veo, Chirp, Lyria）を提供する MCP サーバー。
...
- **対応機能** — 画像生成・参照画像編集・動画生成・TTS・音楽生成
...
| ツール | 説明 | 認証 |
|--------|------|------|
| `generate_image` | Gemini でテキストから画像を生成（参照画像編集にも対応） | 全方式 |
...
| `generate_music` | Lyria で音楽を生成 | Vertex AI / OAuth |
...
- [対応モデル一覧](docs/MODELS.md) — Gemini / Veo / Chirp / Lyria のモデル・エイリアス・料金参考
- [ツール詳細仕様](docs/TOOLS.md) — 全 7 ツールのパラメータ・戻り値・使用例
